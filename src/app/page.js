      ...
      <main className="flex-1">
        <section className="max-w-7xl mx-auto px-6 pt-12 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center space-x-1.5 bg-ring/10 px-3 py-1.5 rounded-full text-[10px] font-bold text-ring uppercase tracking-widest">
        ...
        <section className="bg-card border-t border-b border-border py-16 px-6 transition duration-300">
          <div className="max-w-7xl mx-auto space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {dbError ? (
                <div className="col-span-1 sm:col-span-2 lg:col-span-4 bg-ring/10 border border-ring/25 text-ring p-6 rounded-xl text-xs leading-relaxed max-w-lg mx-auto text-center font-semibold">
        ...
        <section id="partner" className="max-w-4xl mx-auto px-6 py-16 text-center space-y-6">
          <div className="h-10 w-10 rounded-full bg-ring/10 flex items-center justify-center text-ring mx-auto">

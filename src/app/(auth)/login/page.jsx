          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-background border border-border rounded-lg pl-10 pr-4 py-2.5 text-sm text-foreground focus:outline-hidden focus:ring-2 focus:ring-primary/40 transition"
              />
            </div>
          </div>

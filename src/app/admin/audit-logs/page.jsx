            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-border text-sm">
                {logs.map(log => {
                  ...
                  const colorClass = ACTION_COLORS[log.action] || 'bg-secondary text-muted-foreground border-border';
                  return (
                      ...
                      <td className="py-3.5 px-5">
                        {log.user ? (
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <p className="font-bold text-foreground text-xs">{log.user.name}</p>
